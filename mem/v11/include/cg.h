...
int inet_sendto(struct socket *sock, const void *buf, size_t len,const struct sockaddr_in *dest_addr);
int inet_recvfrom(struct socket *sock, void *buf, size_t len, struct sockaddr_in *src_addr);
//#endif // !INET_H
